"""Perplexity and KL divergence evaluation."""
...
def run_perplexity_comparison(
    ...
    """Run fp16 baseline perplexity evaluation for a model."""
    from exq.model_utils import load_model_and_tokenizer
    ...
    results = compute_perplexity(
        model, tokenizer,
        max_length=max_length, stride=stride, max_samples=max_samples,
    )
    return {"model_id": model_id, "config": "fp16_offload", **results}
